#' An AB/BA crossover trial of treatments for mental fatigue
#'
#' Quoted from ###: ""
#'
...
#' }
#'
#' @format A \code{\link[tibble]{tibble}} with 170 rows (observations) and 6
#' columns (variables):
#' \describe{
#'   \item{accuracy}{A continuous outcome measurement. Stored as an
