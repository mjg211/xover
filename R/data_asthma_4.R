#' An AB/BA crossover trial of treatments for asthma
#'
...
#' }
#'
#' @format A \code{\link[tibble]{tibble}} with 172 rows (observations) and 6
#' columns (variables):
#' \describe{
#'   \item{exacerbations}{A continuous outcome measurement. Stored as an
